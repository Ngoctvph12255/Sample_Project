...
public class ChuyenDelFrame extends javax.swing.JInternalFrame {
    ...
    void fillTable() {
        ...
        try {
            ...
            for (ChuyenDe x : listCD) {
                model.addRow(new Object[]{x.getMaCD(), x.getTenCD(), x.getHocPhi(), x.getThoiLuong(), x.getHinhAnh()});
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void deleteData() {
        try {
            int chon = JOptionPane.showConfirmDialog(this, "Bạn có muốn xóa ?", "Xóa", JOptionPane.YES_NO_OPTION, JOptionPane.YES_NO_OPTION);
